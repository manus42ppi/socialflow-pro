...
async function aiCall(messages, max_tokens=800) {
  ...
  return "✨ KI läuft nur auf socialflow-pro.netlify.app (benötigt Backend).";
}
const AI = {
  ...
  return(
    <Card style={{padding:"18px 20px",cursor:onClick?"pointer":"default",transition:"all .15s",userSelect:"none"}} onClick={onClick}
      ...
      <div style={{fontSize:12,color:C.textSoft,marginTop:3,display:"flex",alignItems:"center"}}>
        {label}{onClick&&<span style={{marginLeft:"auto",fontSize:10,color:C.textMute}}>â</span>}
      </div>
    </Card>
  );
}

// ââ CHANNEL ICONS ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
// ââ CHANNEL PREVIEWS âââââââââââââââââââââââââââââââââââââââââââââââââââââââ
function IGPrev({post,media}){
  return <div style={{fontFamily:"'Helvetica Neue',sans-serif",background:"#fff",border:"1px solid #dbdbdb",borderRadius:8,overflow:"hidden",fontSize:13}}>
    <div style={{display:"flex",alignItems:"center",gap:10,padding:"10px 12px"}}>
      ...
      <span style={{marginLeft:"auto",fontSize:18}}>Â·Â·Â·</span>
    </div>
    ...
    <div style={{padding:"10px 12px"}}>
      <div style={{display:"flex",gap:12,fontSize:18,marginBottom:6}}>ð¤ ð¬ â <span style={{marginLeft:"auto"}}>ð</span></div>
      <div><span style={{fontWeight:700}}>dein_account</span> {post.content||"Text hierâ¦"}</div>
...
function TWPrev({post,media}){
  return <div style={{fontFamily:"-apple-system,sans-serif",background:"#fff",border:"1px solid #e1e8ed",borderRadius:12,padding:14,fontSize:13}}>
    <div style={{display:"flex",gap:10}}>
      ...
      <div style={{flex:1}}>
        <div style={{fontWeight:700}}>Dein Name <span style={{color:"#536471",fontWeight:400}}>@handle Â· 2h</span></div>
        <div style={{lineHeight:1.5,marginTop:4}}>{post.content||"Tweetâ¦"}</div>
        ...
        <div style={{display:"flex",gap:16,marginTop:10,color:"#536471",fontSize:11}}>ð¬ 24 &nbsp;ð 12 &nbsp;ð¤ 89</div>
      </div>
    </div>
  </div>;
}
function LIPrev({post,media}){
  return <div style={{fontFamily:"-apple-system,sans-serif",background:"#fff",border:"1px solid #e0e0e0",borderRadius:8,overflow:"hidden",fontSize:13}}>
    <div style={{padding:"12px 14px",display:"flex",gap:10}}>
      ...
      <div><div style={{fontWeight:700}}>Dein Name</div><div style={{fontSize:11,color:"#666"}}>Position Â· 1. Grad</div></div>
    </div>
    <div style={{padding:"0 14px 10px",lineHeight:1.6}}>{post.content||"Postâ¦"}{post.hashtags&&<span style={{color:"#0077B5"}}> {post.hashtags}</span>}</div>
    ...
    <div style={{display:"flex",borderTop:"1px solid #e0e0e0"}}>
      {["ð","ð¬","â"].map(a=><button key={a} style={{flex:1,background:"none",border:"none",color:"#666",fontSize:12,fontWeight:700,padding:"7px 0",cursor:"pointer"}}>{a}</button>)}
    </div>
  </div>;
}
function FBPrev({post,media}){
  return <div style={{fontFamily:"Helvetica,sans-serif",background:"#fff",border:"1px solid #dddfe2",borderRadius:8,overflow:"hidden",fontSize:13}}>
    <div style={{padding:"10px 12px",display:"flex",gap:8}}>
      ...
      <div><div style={{fontWeight:700}}>Deine Seite</div><div style={{fontSize:11,color:"#65676b"}}>Gerade Â· ð</div></div>
    </div>
    <div style={{padding:"0 12px 10px",lineHeight:1.5}}>{post.content||"Postâ¦"}{post.hashtags&&<span style={{color:"#1877F2"}}> {post.hashtags}</span>}</div>
    {media?.url&&<img src={media.url} alt="" style={{width:"100%",aspectRatio:"1.91/1",objectFit:"cover",display:"block"}}/>}
    <div style={{display:"flex",borderTop:"1px solid #dddfe2"}}>
      {["ð","ð¬","â"].map(a=><button key={a} style={{flex:1,background:"none",border:"none",color:"#65676b",fontSize:12,fontWeight:700,padding:"7px 0",cursor:"pointer"}}>{a}</button>)}
    </div>
  </div>;
}
  ...
  return <div style={{background:"#000",borderRadius:10,maxWidth:200,color:"#fff",overflow:"hidden",margin:"0 auto"}}>
    <div style={{aspectRatio:"9/16",background:"linear-gradient(180deg,#111,#333)",position:"relative"}}>
      ...
      <div style={{position:"absolute",bottom:0,left:0,right:0,padding:8,background:"linear-gradient(transparent,rgba(0,0,0,.8))"}}>
        ...
        <div style={{fontSize:10,lineHeight:1.4,opacity:.9}}>{post.content?.slice(0,50)||"TikTokâ¦"}</div>
      </div>
    </div>
  </div>;
}
  ...
  return <div style={{background:"#ECE5DD",borderRadius:10,overflow:"hidden",fontSize:13}}>
    ...
    <div style={{padding:"12px 10px",minHeight:80}}>
      <div style={{background:"#fff",borderRadius:"0 10px 10px 10px",padding:"8px 12px",display:"inline-block",maxWidth:"85%",boxShadow:"0 1px 2px rgba(0,0,0,.1)"}}>
        ...
        <div style={{fontSize:12,color:"#111",lineHeight:1.5}}>{post.content||"Nachrichtâ¦"}</div>
        <div style={{fontSize:10,color:"#999",textAlign:"right",marginTop:3}}>10:32 ââ</div>
      </div>
    </div>
  </div>;
}
    ...
    <div style={{minHeight:"100vh",background:"linear-gradient(150deg,#0D0F12,#1a1d24 60%,#0D0F12)",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:FONT,padding:16}}>
      ...
      <div style={{width:"100%",maxWidth:420,animation:"fadeUp .4s ease",position:"relative",zIndex:1}}>
        ...
        <Card style={{padding:"28px 26px"}}>
          <h2 style={{margin:"0 0 20px",fontSize:18,fontWeight:800,color:C.text}}>Willkommen zurÃ¼ck</h2>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:12}}>
            ...
            <TIn label="Passwort" icon={Lock} type="password" placeholder="â¢â¢â¢â¢â¢â¢â¢â¢" value={pw} onChange={e=>setPw(e.target.value)} onKeyDown={e=>e.key==="Enter"&&go()}/>
            ...
            <button onClick={go} disabled={ld} style={{padding:10,borderRadius:8,border:"none",background:C.accent,color:"#fff",fontWeight:700,fontSize:14,cursor:ld?"not-allowed":"pointer",fontFamily:FONT,display:"flex",alignItems:"center",justifyContent:"center",gap:8}}>
              {ld?<><Sp/>Anmeldenâ¦</>:"Anmelden"}
            </button>
          </div>
          <div style={{marginTop:16,padding:"12px 14px",background:C.bg,borderRadius:10,border:`1px solid ${C.border}`}}>
            <div style={{fontSize:11,fontWeight:700,color:C.textSoft,marginBottom:7,display:"flex",alignItems:"center",gap:5}}><Shield size={11} strokeWidth={2}/>Demo-ZugÃ¤nge (klicken)</div>
...
// ââ SIDEBAR + TOPBAR âââââââââââââââââââââââââââââââââââââââââââââââââââââââ
const NAV=[
...
function TopBar({title,user,saving}){
  return(
    <div style={{height:54,background:C.surface,borderBottom:`1px solid ${C.border}`,display:"flex",alignItems:"center",padding:"0 22px",gap:14,flexShrink:0}}>
      ...
      <div style={{flex:1}}/>
      {saving&&<div style={{fontSize:11,color:"#48BB78",display:"flex",alignItems:"center",gap:5}}><span style={{width:6,height:6,borderRadius:"50%",background:"#48BB78",display:"inline-block"}}/>Gespeichert â</div>}
...
// ââ AI PANEL âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
function AIPanel({content,chId,onApply,onApplyHT}){
  ...
  const run=async()=>{
    ...
    }catch{setRes("Fehler â nochmal versuchen.");}
    setLd(false);
  };
  return(
    <div style={{background:C.purpleBg,borderRadius:10,border:`1px solid ${C.purple}25`,overflow:"hidden"}}>
      ...
      <div style={{padding:"0 10px 10px",display:"flex",flexDirection:"column",gap:8}}>
        ...
        <Btn variant="ai" size="sm" onClick={run} disabled={ld||!content.trim()} style={{justifyContent:"center"}}>
          {ld?<><Sp/>Verarbeiteâ¦</>:<><Zap size={13} strokeWidth={2}/>{tab==="opt"?"Optimieren":tab==="ht"?"Hashtags":"3 Varianten"}</>}
        </Btn>
        {res&&<div style={{background:C.surface,borderRadius:8,padding:"9px 11px",border:`1px solid ${C.border}`,fontSize:12,lineHeight:1.6,color:C.textMid}}>
          ...
          <div style={{marginTop:8,display:"flex",gap:6}}>
            <Btn size="sm" variant="success" onClick={()=>{(tab==="ht"?onApplyHT:onApply)(res);setRes("");}}><Check size={12} strokeWidth={2.5}/>Ãbernehmen</Btn>
...
// ââ MEDIA PICKER MODAL (inline â bleibt Ã¼ber dem Editor) âââââââââââââââââââ
    ...
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.6)",zIndex:3000,display:"flex",alignItems:"center",justifyContent:"center",padding:16}} onClick={e=>e.target===e.currentTarget&&onClose()}>
      <Card style={{width:"100%",maxWidth:700,maxHeight:"78vh",display:"flex",flexDirection:"column",overflow:"hidden",boxShadow:"0 24px 64px rgba(0,0,0,.25)"}}>
        <div style={{padding:"14px 18px",borderBottom:`1px solid ${C.borderLight}`,display:"flex",alignItems:"center",gap:12}}>
          <div style={{flex:1,fontWeight:800,fontSize:15,color:C.text}}>Medium auswÃ¤hlen</div>
        ...
        <div style={{padding:"10px 18px",borderBottom:`1px solid ${C.borderLight}`,display:"flex",gap:10}}>
          <div style={{position:"relative",flex:1}}>
            ...
            <input value={q} onChange={e=>setQ(e.target.value)} placeholder="Sucheâ¦" style={{width:"100%",padding:"7px 10px 7px 28px",borderRadius:7,border:`1px solid ${C.border}`,fontSize:12,outline:"none",fontFamily:FONT,boxSizing:"border-box"}}/>
          </div>
...
// ââ MEDIA DETAIL MODAL (FIX: onMouseDown statt onClick fÃ¼r Fokuspunkt) ââââââ
    ...
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.5)",zIndex:2000,display:"flex",alignItems:"center",justifyContent:"center",padding:16}} onClick={e=>e.target===e.currentTarget&&onClose()}>
      <Card style={{width:"100%",maxWidth:780,maxHeight:"92vh",overflow:"hidden",display:"flex",boxShadow:"0 24px 64px rgba(0,0,0,.22)"}}>
        <div style={{width:290,flexShrink:0,background:C.bg,display:"flex",flexDirection:"column"}}>
          ...
          <div style={{padding:"12px 14px",display:"flex",flexDirection:"column",gap:8}}>
            ...
            <button onMouseDown={e=>{e.stopPropagation();setFmode(v=>!v);}} style={{display:"flex",alignItems:"center",gap:7,padding:"8px 12px",borderRadius:8,border:`1px solid ${fmode?C.accent:C.border}`,background:fmode?C.accentLight:C.surface,color:fmode?C.accent:C.textMid,fontWeight:600,fontSize:12,cursor:"pointer",fontFamily:FONT}}>
              <MapPin size={14} strokeWidth={2}/>{fmode?"Bild anklickenâ¦":"Fokuspunkt setzen"}
            </button>
        ...
        <div style={{flex:1,overflow:"auto",padding:"20px 22px",display:"flex",flexDirection:"column",gap:12}}>
          ...
          <TIn label="Tags (kommagetrennt)" icon={Tag} value={form.tags||""} onChange={e=>setForm({...form,tags:e.target.value})} placeholder="produkt, teamâ¦"/>
          <TIn label="Alt-Text" value={form.altText||""} onChange={e=>setForm({...form,altText:e.target.value})} placeholder="FÃ¼r Screenreader"/>
          <div>
            <FL>Kategorie</FL>
...
// ââ EDITOR MODAL âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
        ...
        <div style={{flex:1,overflow:"auto",padding:"22px 24px",borderRight:`1px solid ${C.borderLight}`,display:"flex",flexDirection:"column",gap:13}}>
          ...
          {campaigns?.length>0&&<div><FL>Kampagne (optional)</FL>
            <select value={form.campaignId||""} onChange={e=>setForm(f=>({...f,campaignId:e.target.value||null}))} style={{width:"100%",padding:"8px 12px",borderRadius:8,border:`1px solid ${C.border}`,fontSize:13,fontFamily:FONT,color:C.text}}>
              <option value="">â Keine Kampagne â</option>
              {campaigns.map(c=><option key={c.id} value={c.id}>{c.emoji} {c.name}</option>)}
            </select>
          </div>}

          <TIn label="Titel (intern)" icon={FileText} placeholder="Kurzer Arbeitstitelâ¦" value={form.title||""} onChange={e=>setForm({...form,title:e.target.value})}/>

          <div>
            <FL>Text {(form.content?.length||0)>0&&<span style={{float:"right",color:(form.content?.length||0)>maxC?C.accent:C.textMute,fontWeight:400,fontSize:11}}>{form.content?.length}/{maxC===9999?"â":maxC}</span>}</FL>
            <textarea value={form.content||""} onChange={e=>setForm({...form,content:e.target.value})} placeholder="Was mÃ¶chtest du teilen?" style={{width:"100%",minHeight:100,padding:"9px 12px",borderRadius:8,border:`1px solid ${C.border}`,fontSize:13,outline:"none",fontFamily:FONT,resize:"vertical",boxSizing:"border-box",color:C.text}}/>
          </div>
          ...
          {/* MEDIA â inline picker, never navigates away */}
          <div><FL>Mediendatei</FL>
            {media?(
              <div style={{display:"flex",gap:10,alignItems:"center",background:C.bg,borderRadius:8,padding:"8px 12px",border:`1px solid ${C.border}`}}>
                ...
                <Btn size="sm" variant="secondary" onClick={()=>setPicker(true)}><Edit2 size={11} strokeWidth={2}/>Ãndern</Btn>
              ...
              <button onClick={()=>setPicker(true)} style={{width:"100%",padding:12,borderRadius:8,border:`1.5px dashed ${C.border}`,background:C.bg,color:C.textSoft,fontSize:13,fontWeight:600,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:8,fontFamily:FONT,transition:"all .15s"}}
                ...
                <Image size={16} strokeWidth={IW}/>Aus Medienbibliothek wÃ¤hlen oder hochladen
              </button>
            )}
          </div>
      ...
      <Card style={{width:"100%",maxWidth:400,boxShadow:"0 20px 60px rgba(0,0,0,.15)"}}>
        ...
        <div style={{padding:"14px 22px 22px",display:"flex",flexDirection:"column",gap:12}}>
          <div style={{background:C.bg,borderRadius:8,padding:"10px 12px",border:`1px solid ${C.border}`}}>
            ...
            <div style={{color:C.textSoft,fontSize:12,marginTop:2}}>{post.content?.slice(0,80)}{(post.content?.length||0)>80?"â¦":""}</div>
          </div>
          ...
          <div style={{display:"flex",gap:8}}>
            <Btn variant="secondary" onClick={onClose} style={{flex:1,justifyContent:"center"}}>Abbrechen</Btn>
            <Btn onClick={()=>{if(!date){alert("Bitte Datum wÃ¤hlen.");return;}onSave({...post,scheduledDate:date,scheduledTime:time,channels:chs,status:"scheduled"});}} style={{flex:2,justifyContent:"center"}}><Check size={14} strokeWidth={2.5}/>Planen</Btn>
          </div>
        </div>
      </Card>
    </div>
  ...
  return(
    <Card style={{overflow:"hidden",transition:"box-shadow .2s"}}
      ...
      {post.status==="scheduled"&&post.scheduledDate&&<div style={{padding:"6px 14px",background:C.successBg,borderTop:`1px solid #A7F3D0`,display:"flex",alignItems:"center",gap:6,fontSize:12,color:C.success,fontWeight:600}}>
        <Calendar size={12} strokeWidth={2}/>{fmtDate(post.scheduledDate)}{post.scheduledTime&&` Â· ${post.scheduledTime}`}
      </div>}
      ...
      <div style={{display:"flex",borderTop:`1px solid ${C.borderLight}`}}>
        ...
        <button onClick={()=>onSched(post)} style={{flex:1,padding:"9px 0",background:"none",border:"none",color:post.status==="scheduled"?C.success:C.accent,fontWeight:700,fontSize:12,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:5,fontFamily:FONT}}>
          <Calendar size={13} strokeWidth={IW}/>{post.status==="scheduled"?"Ãndern":"Planen"}
        </button>
      </div>
    </Card>
  );
}
// ââ KANBAN CARD ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  return(
    <div draggable onDragStart={e=>{e.dataTransfer.effectAllowed="move";onDS(post.id,post.status);}} onClick={()=>onEdit(post)}
      ...
      <div style={{padding:"9px 11px"}}>
        ...
        <div style={{fontSize:11,color:C.textSoft,lineHeight:1.4,display:"-webkit-box",WebkitLineClamp:2,WebkitBoxOrient:"vertical",overflow:"hidden",marginBottom:7}}>{post.content||"Kein Textâ¦"}</div>
    ...
    <div style={{flex:1,overflow:"auto",padding:22,display:"flex",flexDirection:"column"}}>
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:18,flexShrink:0}}>
        <div>
          ...
          <div style={{fontSize:12,color:dId?C.accent:C.textSoft,fontWeight:dId?700:400,marginTop:2}}>{dId?"Ziehe in eine andere Spalteâ¦":"Drag & Drop zum Verschieben"}</div>
        </div>
        <div style={{display:"flex",gap:8}}>
        ...
        {cols.map(col=>{
          ...
          return(
            <div key={col.id}
              ...
              {isO&&dId&&!isS&&<div style={{margin:"8px 8px 0",padding:10,borderRadius:8,border:`2px dashed ${col.color}`,background:col.color+"0A",display:"flex",alignItems:"center",justifyContent:"center",fontSize:12,color:col.color,fontWeight:700}}>ð Hier ablegen</div>}
...
// ââ CAMPAIGNS PAGE âââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
function CampaignsPage({campaigns,setCampaigns,posts,onEditPost}){
  const [showNew,setShowNew]=useState(false);
  const [form,setForm]=useState({name:"",emoji:"ð¯",color:C.accent,description:""});
  const [sel,setSel]=useState(null);

  const create=()=>{if(!form.name.trim())return;setCampaigns(p=>[...p,{id:uid(),...form}]);setShowNew(false);setForm({name:"",emoji:"ð¯",color:C.accent,description:""}); };
  const del=id=>{if(window.confirm("Kampagne lÃ¶schen?")){setCampaigns(p=>p.filter(c=>c.id!==id));if(sel===id)setSel(null);}};
    ...
    <div style={{flex:1,overflow:"auto",padding:22,display:"flex",gap:20}}>
      ...
      <div style={{width:280,flexShrink:0,display:"flex",flexDirection:"column",gap:12}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
          ...
          <Btn size="sm" onClick={()=>setShowNew(s=>!s)}><Plus size={13} strokeWidth={2}/>{showNew?"SchlieÃen":"Neu"}</Btn>
        </div>
        ...
        {showNew&&<Card style={{padding:"14px 16px"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:10}}>
            ...
            <TIn label="Name" placeholder="z.B. Sommer, Olympia, Osternâ¦" value={form.name} onChange={e=>setForm(f=>({...f,name:e.target.value}))}/>
            <TIn label="Beschreibung (optional)" placeholder="Kurze Infoâ¦" value={form.description} onChange={e=>setForm(f=>({...f,description:e.target.value}))}/>
            <div><FL>Farbe</FL>
        ...
        {campaigns.length===0&&!showNew&&<div style={{textAlign:"center",padding:"40px 16px",color:C.textMute}}>
          ...
          <div style={{fontSize:12}}>Erstelle z.B. âSommer", âOlympia" oder âOstern"</div>
        </div>}
      ...
      <div style={{flex:1,minWidth:0}}>
        {selC?(
          ...
          <div style={{textAlign:"center",padding:"80px 20px",color:C.textMute}}>
            ...
            <div style={{fontSize:16,fontWeight:700,color:C.textMid}}>Kampagne auswÃ¤hlen</div>
...
// ââ MEDIA PAGE âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
    ...
    <div style={{flex:1,overflow:"auto",padding:22,display:"flex",flexDirection:"column",gap:14}}>
      <div style={{display:"flex",gap:10,alignItems:"center",flexWrap:"wrap"}}>
        <div style={{position:"relative",flex:1,minWidth:180,maxWidth:300}}>
          <Search size={13} color={C.textMute} strokeWidth={IW} style={{position:"absolute",left:9,top:"50%",transform:"translateY(-50%)"}}/>
          <input value={q} onChange={e=>setQ(e.target.value)} placeholder="Name, Tags suchenâ¦" style={{width:"100%",padding:"8px 10px 8px 28px",borderRadius:8,border:`1px solid ${C.border}`,fontSize:12,outline:"none",fontFamily:FONT,boxSizing:"border-box"}}/>
        </div>
      ...
      <div style={{flex:1}} onDragOver={e=>{e.preventDefault();setDrag(true);}} onDragLeave={()=>setDrag(false)} onDrop={e=>{e.preventDefault();setDrag(false);upload(e.dataTransfer.files);}}>
        ...
        {items.length===0?(
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(165px,1fr))",gap:12}}>
            {list.map(item=>(
              <div key={item.id} style={{borderRadius:10,overflow:"hidden",border:`1px solid ${C.border}`,background:C.surface,transition:"all .15s"}}
                ...
                <div style={{padding:"8px 10px"}}>
                  ...
                  <div style={{fontSize:11,color:C.textMute,marginTop:1}}>{item.type} Â· {item.date}</div>
                  {item.tags&&<div style={{fontSize:10,color:C.purple,marginTop:2,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>ð· {item.tags}</div>}
            ...
            {list.length===0&&q&&<div style={{gridColumn:"1/-1",textAlign:"center",padding:40,color:C.textMute}}>Keine Treffer fÃ¼r â{q}"</div>}
          </div>
        )}
      </div>
  ...
  return(
    <div style={{flex:1,overflow:"auto",padding:22,display:"flex",flexDirection:"column",gap:16}}>
      <Card style={{padding:"20px 24px",background:"linear-gradient(135deg,#0D0F12,#1f2937)",border:"none"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
          <div>
            <div style={{fontSize:19,fontWeight:900,color:"#fff"}}>Guten Tag, {user.name.split(" ")[0]}! ð</div>
            <div style={{fontSize:13,color:"#9ca3af",marginTop:4}}>
              <strong style={{color:"#fff"}}>{sched.length} geplant</strong> Â· <strong style={{color:"#fff"}}>{pend.length} zur Freigabe</strong> Â· <strong style={{color:"#fff"}}>{campaigns.length} Kampagnen</strong>
            </div>
          </div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(165px,1fr))",gap:12}}>
        ...
        <SCrd icon={FileText} label="EntwÃ¼rfe"  value={drafts.length} delta={-3} color={C.warning} onClick={()=>onFilterNav("publisher","draft")}/>
...
// ââ PUBLISHER PAGE âââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  return(
    <div style={{flex:1,overflow:"hidden",display:"flex",flexDirection:"column"}}>
      <div style={{padding:"10px 22px",borderBottom:`1px solid ${C.border}`,background:C.surface,display:"flex",gap:10,alignItems:"center",flexShrink:0}}>
        <div style={{display:"flex",gap:2,background:C.borderLight,borderRadius:8,padding:3}}>
          {[["grid","â Grid"],["board","â Board"]].map(([v,l])=>(
        ...
        {view==="grid"&&<div style={{display:"flex",gap:3,background:C.borderLight,borderRadius:8,padding:3}}>
          {[["all","Alle",posts.length],["scheduled","Geplant",posts.filter(p=>p.status==="scheduled").length],["draft","EntwÃ¼rfe",posts.filter(p=>p.status==="draft").length],["pending","Freigabe",posts.filter(p=>p.status==="pending").length]].map(([v,l,c])=>(
...
// ââ PERFORMANCE PAGE âââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  return(
    <div style={{flex:1,overflow:"auto",padding:22,display:"flex",flexDirection:"column",gap:16}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(150px,1fr))",gap:12}}>
        ...
        <SCrd icon={Star}         label="Ã Engagement" value="5.7%"  delta={2}  color={C.warning}/>
...
// ââ CALENDAR PAGE ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  return(
    <div style={{flex:1,overflow:"auto",padding:22,display:"flex",flexDirection:"column",gap:16}}>
      <div style={{display:"flex",gap:3,background:C.borderLight,borderRadius:9,padding:4,alignSelf:"flex-start"}}>
        {[["users","Benutzer",Users],["channels","KanÃ¤le",Globe],["settings","Einstellungen",Settings]].map(([id,l,Ic])=>(
      ...
      {tab==="settings"&&<div style={{maxWidth:520,display:"flex",flexDirection:"column",gap:14}}>
        ...
        <Card style={{padding:"14px 18px"}}>
          ...
          {[["onSched","Post geplant"],["onAppr","Freigabe angefordert"],["onPub","Post verÃ¶ffentlicht"],["onErr","Fehler beim Posten"]].map(([key,label])=>(
...
function App(){
  ...
  if(!dbReady&&user) return(
    <div style={{display:"flex",alignItems:"center",justifyContent:"center",height:"100vh",background:C.bg,flexDirection:"column",gap:16}}>
      ...
      <div style={{fontSize:14,color:C.textMute}}>Deine Daten werden geladenâ¦</div>
  ...
  const del=id=>{if(window.confirm("Post lÃ¶schen?"))setPosts(prev=>prev.filter(p=>p.id!==id));};
