...
export const DEMO_CAMPAIGNS = [
  ...
  { id:"c2", name:"Thought Leadership Q2", icon:"Crown", color:"#0077B5", description:"Positionierung als fuehrende Stimme im digitalen Content Marketing durch Artikel und LinkedIn.", goal:"engagement", status:"active", startDate:"2026-04-01", endDate:"2026-06-30", channels:["linkedin","website","twitter"], keyMessage:"Content ist Koenig. Strategie ist die Krone.", cta:"Artikel lesen", audience:{ ageRange:"28-50", gender:"all", locations:"Deutschland", interests:"Marketing, Leadership, Business" }, budget:{ total:6000, spent:1200, currency:"EUR" }, kpis:{ impressions:300000, reach:90000, engagementRate:5.8, clicks:9000 }, createdAt:"2026-03-20" },
